...
## [0.5.0](https://github.com/QuEraComputing/vihaco/compare/v0.4.0...v0.5.0) - 2026-09-23

### Other

- Changed CPU to use `u64` as its value ([#85](https://github.com/QuEraComputing/vihaco/pull/85))
- Update CPU frame model ([#110](https://github.com/QuEraComputing/vihaco/pull/110))
